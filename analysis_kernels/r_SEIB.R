...
nc_name  <- 'data/SEIB/cruncep_netcdfs_v6/seib_cruncep_npp_annual_1901_2014.nc4'
ncin <-  nc_open (nc_name)
...
# Calculate CRUN tau_NPP for SEIB
#----------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------
SEIB_CRUN_nta_adj <- SEIB_CRUN_nta * (forest_mask_NA / 100.0)
