...
# Read LPJmL forest mask
#----------------------------------------------------------------------------------------
LPJmL_forest_mask    <- array (NA, dim = c (720, 360))
nc_name <- 'Shared_files//forest_mask/lpjml_cruncep_lai_annual_1901_2014_forest_mask_v4.nc'
...
nc_name <- 'Shared_files/phenology/lpjml_cruncep_lai_annual_1901_2014_phenology_mask.nc'
ncin <-  nc_open (nc_name)
...
nc_name  <- 'data/LPJmL/lpjml_cruncep_cveg_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
...
#----------------------------------------------------------------------------------------
nc_name  <- 'data/LPJmL/lpjml_cruncep_cmort_fire_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
tmp <- ncvar_get (ncin, 'cmort_fire', start = c (1, 1, 1, 85), count = c (720, 279, 9, 30)) # Extract variable

# Get cmort_groweff [kg m-2 s-1]
#----------------------------------------------------------------------------------------
nc_name  <- 'data/LPJmL/lpjml_cruncep_cmort_growth_efficiency_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
...
#----------------------------------------------------------------------------------------
nc_name  <- 'data/LPJmL/lpjml_cruncep_cmort_neg_allocation_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
...
#----------------------------------------------------------------------------------------
nc_name  <- 'data/LPJmL/lpjml_cruncep_cmort_neg_biomass_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
...
#----------------------------------------------------------------------------------------
nc_name  <- 'data/LPJmL/lpjml_cruncep_cmort_heatstress_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
tmp4 <- ncvar_get (ncin, 'cmort_heatstress', start = c (1, 1, 1, 85), count = c (720, 279, 9, 30)) # Extract variable

# Get cmort_shade [kg m-2 s-1]
#----------------------------------------------------------------------------------------
nc_name  <- 'data/LPJmL/lpjml_cruncep_cmort_shade_annual_1901_2014.nc'
ncin <-  nc_open (nc_name)
...
#----------------------------------------------------------------------------------------
LPJmL_CRUN_tau_adj <- LPJmL_CRUN_tau * (forest_mask_NA / 100.0)
