function [vstock,mflux,lrflux,nppflux,reproflux,vstock_jules,mflux_jules,lrflux_jules,...
...
%and extract mean arrays of fluxes and vegetation stocks for a specified time window.
%
%T. Pugh
%27.11.19
