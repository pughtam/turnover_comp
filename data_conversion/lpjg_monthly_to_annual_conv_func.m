%Script to read in LPJ-GUESS monthly by pft data and convert it to annual for
%manageability
%
%T. Pugh
%25.04.16

indir='/home/pughtam/data/turnover/LPJG/IPSL_v2/netcdfs/';
outdir='/home/pughtam/data/turnover/LPJG/IPSL_v2/netcdfs/';

file_in='lpj-guess_ipsl_gpp_monthly_1901_2099.nc4';
file_out='lpj-guess_ipsl_gpp_annual_1901_2099.nc4';

varname='gpp';

ifpft=true; %Does the file have a PFT dimension?
...
netcdf.putAtt(ncid,varid,'Note',['Created from ',file_in,' using lpjg_monthly_to_annual_conv_func.m ',date])
